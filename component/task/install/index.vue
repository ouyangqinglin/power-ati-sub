  ...
  <div class="app-container pages-task">
    <el-card class="pages-task-header" >
      <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="100px">
        <common-flex>
          ...
          <el-form-item class="second-item" :label="`${$t('task.installer')}：`" prop="installer" label-width="200px">
            <el-input
              class="same-input"
      ...
      <el-form :model="queryParams" :inline="true" label-width="100px">
        ...
        <el-form-item class="second-item" :label="`${$t('task.taskCompletedTime')}：`" prop="endTime" style="margin-bottom: 0" label-width="200px">
          <el-date-picker
            class="same-input"
            clearable
            v-model="queryTime"
    ...
    <el-card>
      ...
      <el-table :header-cell-style="{'text-align': 'center', 'border-bottom': 'none' }" :cell-style="{'text-align': 'center', 'border-left': 'none', 'border-right': 'none', 'border-top': 'none'}" border
        ...
        <el-table-column :label="$t('task.installer')" align="center" prop="installer" min-width="130" show-tooltip-when-overflow />
    ...
    <AddDialog :show.sync="showModel" :type="1" :header="`${$t('common.pleaseSelect')}${$t('common.customer')}`" />
